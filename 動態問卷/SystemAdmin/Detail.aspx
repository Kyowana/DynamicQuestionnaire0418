...
<body>
    <form id="form1" runat="server">
        ...
        <div style="float: left">
            ...
            <div>
                <asp:PlaceHolder ID="page01" runat="server">問卷名稱<asp:TextBox ID="txtCaption" runat="server" /><br />
                    ...
                    <asp:Label ID="lblPage1Msg" runat="server" Text="問卷名稱及開始/結束時間為必填" ForeColor="Red" Visible="false"></asp:Label>
                    <asp:Label ID="lblPage1Msg2" runat="server" Text="結束時間不得早於開始時間" ForeColor="Red" Visible="false"></asp:Label><br />
            ...
            <asp:Button ID="btnAdd" runat="server" Text="加入" OnClick="btnAdd_Click" /><br />
                ...
                <asp:PlaceHolder ID="page03" runat="server" Visible="false">
                    ...
                    <asp:PlaceHolder ID="plcPage03_2" runat="server" Visible="false">姓名&emsp;<asp:TextBox ID="txtName" runat="server" Enabled="false" />&emsp;
